...
var AppComponent = (function () {
    function AppComponent(http) {
        this.title = 'Steven\'s Giphy Search';
        this.query = 'http://api.giphy.com/v1/gifs/search?api_key=W9694uE7E0PQ91pv5jUgxXsn7GnJ3sSR&limit=20&q=';
        this.gifs = [];
        this.http = http;
    }
    ...
    AppComponent.prototype.searchForGifs = function (search) {
        var _this = this;
